...
public class Tank : MonoBehaviour
{
    ...
    [SerializeField] private Bullet[] _bulletsTemplates;
    ...
    private void Shoot()
    {
        Instantiate(_bulletsTemplates[Random.Range(0, _bulletsTemplates.Length)], _shootPoint.position, Quaternion.identity);
    }
}
